...
public class AddClothesActivity extends AppCompatActivity {
    ...
    public String uid = user.getEmail();
    ...
    private void uploadFile() {
        ...
        if (filePath != null) {
            ...
            {storageRef = storage.getReference( uid + "/Accessary/" + filename); clothes = "Accessary";}
            ...
            {storageRef = storage.getReference( uid + "/Top/" + filename);clothes = "Top";}
            ...
            {storageRef = storage.getReference( uid + "/Bottom/" + filename);clothes = "Bottom";}
            else {storageRef = storage.getReference( uid + "/Outer/" + filename);clothes = "Outer";}
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    storageRef.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                        ...
                        public void onSuccess(Uri uri) {
                            ...
                            DatabaseReference userstore = FirebaseDatabase.getInstance().getReference().child("User");
                            DatabaseReference imagestore = userstore.push();


                            if(clothes.equals("Outer")){
                                HashMap<String, String> hashMap = new HashMap<>();
                                ImageUploadInfo imageUploadInfo = new ImageUploadInfo(uid, String.valueOf(uri), cloth_type);
                                imagestore.child("Outer").push().setValue(imageUploadInfo).addOnSuccessListener(new OnSuccessListener<Void>() {
                                    @Override
                                    public void onSuccess(Void aVoid) {
                                        Toast.makeText(AddClothesActivity.this, "Finally Completed", Toast.LENGTH_SHORT).show();
                                    }
                                });
                                ...
                                HashMap<String, String> hashMap = new HashMap<>();
                                ImageUploadInfo imageUploadInfo = new ImageUploadInfo(uid, String.valueOf(uri), cloth_type);
                                imagestore.child("Top").push().setValue(imageUploadInfo).addOnSuccessListener(new OnSuccessListener<Void>() {
                                    @Override
                                    public void onSuccess(Void aVoid) {
                                        Toast.makeText(AddClothesActivity.this, "Finally Completed", Toast.LENGTH_SHORT).show();
                                    }
                                ...
                                HashMap<String, String> hashMap = new HashMap<>();
                                ImageUploadInfo imageUploadInfo = new ImageUploadInfo(uid, String.valueOf(uri), cloth_type);
                                imagestore.child("Bottom").push().setValue(imageUploadInfo).addOnSuccessListener(new OnSuccessListener<Void>() {
                                    @Override
                                    public void onSuccess(Void aVoid) {
                                        Toast.makeText(AddClothesActivity.this, "Finally Completed", Toast.LENGTH_SHORT).show();
                                    }
                                ...
                                HashMap<String, String> hashMap = new HashMap<>();
                                ImageUploadInfo imageUploadInfo = new ImageUploadInfo(uid, String.valueOf(uri), cloth_type);
                                imagestore.child("Accessary").push().setValue(imageUploadInfo).addOnSuccessListener(new OnSuccessListener<Void>() {
                                    @Override
                                    public void onSuccess(Void aVoid) {
                                        Toast.makeText(AddClothesActivity.this, "Finally Completed", Toast.LENGTH_SHORT).show();
                                    }
